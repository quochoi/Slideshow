...
class SlideshowCategoryAdminValidator extends AbstractValidator
{
    protected static $rules = array(
        'slideshow_category_name' => 'required',
    );
    ...
    public function isValidTitle($input) {
        ...
        if ((strlen($slideshow_category_name) <= $min_lenght)  || ((strlen($slideshow_category_name) >= $max_lenght))) {
